...
Input Nama Lengkap
    ...
    # ${getName}             Get Value                   id:nama
    Set Global Variable    ${name}
    Set Global Variable    ${rand}      
    
Input Gelar Depan   
    [Arguments]     ${gelarD}
    Input Text    id:gelar_depan    ${gelarD}

Input Gelar Belakang    
    [Arguments]     ${gelarB}
    Input Text    id:gelar_belakang     ${gelarB}
...
Input IP S1
    [Arguments]    ${ipS1}
    Input Text     id:ip_s1    ${ipS1}

Input IP Profesi
    [Arguments]    ${ipProfesi}
    Input Text     id:ip_profesi    ${ipProfesi}

Input IP Komulatif
    [Arguments]    ${ipKumulatif}
    Input Text     id:ip_kumulatif    ${ipKumulatif}
